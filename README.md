...
[Download](https://github.com/arcticicestudio/nord-visual-studio-code/releases/latest) the latest [`nord-visual-studio-code-0.0.0.vsix`](https://github.com/arcticicestudio/nord-visual-studio-code/releases/download/0.0.0/nord-visual-studio-code-0.0.0.vsix) file from the GitHub repository and install it from the command line
```shell
code --install-extension nord-visual-studio-code-0.0.0.vsix
```
...
## Development
[![](https://img.shields.io/badge/Changelog-0.0.0-blue.svg)](https://github.com/arcticicestudio/nord-visual-studio-code/blob/v0.0.0/CHANGELOG.md) [![](https://img.shields.io/badge/Workflow-gitflow--branching--model-blue.svg)](http://nvie.com/posts/a-successful-git-branching-model) [![](https://img.shields.io/badge/Versioning-ArcVer_0.8.0-blue.svg)](https://github.com/arcticicestudio/arcver)
